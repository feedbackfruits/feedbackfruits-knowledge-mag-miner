...
function mine(type, startPage = config_1.START_PAGE, endPage = config_1.END_PAGE, pageSize = config_1.PAGE_SIZE) {
    return new rxjs_1.Observable(observer => {
        (() => __awaiter(this, void 0, void 0, function* () {
            ...
            while (!done) {
                ...
                const docs = feedbackfruits_knowledge_engine_1.Helpers.quadsToDocs(quads);
                yield Promise.all(docs.map(doc => observer.next(doc)));
                page++;
